"""Cross-input constraints for v2 ``flash_attn_func``.

Each Q axis is generated directly from its YAML domain. This constraint only
links dependent inputs and removes unsupported combinations.
"""
...
@GENERATOR_REGISTRY.register("flash_attn_func_v2_constraints")
class FlashAttnFuncV2Constraints(CaseGenerator):
    def after_case_config(self, case_config):
        ...
        # causal + Sq > Sk is a separately tracked known NPU issue.
