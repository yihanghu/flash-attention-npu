"""Standalone CPU marker for v2 flash_attn_varlen_func."""
...
def flash_attn_varlen_func(
    ...
    if dropout_p != 0.0 or alibi_slopes is not None or block_table is not None:
        raise NotImplementedError("This marker covers the v2 910-supported subset")
    ...
    for index in range(cu_seqlens_q.numel() - 1):
        ...
        output[qs:qe] = _attention(
            q[qs:qe], k[ks:ke], v[ks:ke], softmax_scale, causal, window_size, softcap
        )
    return output
