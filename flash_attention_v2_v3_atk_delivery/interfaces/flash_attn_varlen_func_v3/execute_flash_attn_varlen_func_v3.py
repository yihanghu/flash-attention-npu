"""ATK CPU/GPU/NPU adapter for v3 flash_attn_varlen_func."""
...
from benchmark_flash_attn_varlen_func_v3 import flash_attn_varlen_func as cpu_flash_attn_varlen_func
...
@register("flash_attn_varlen_func_v3_accuracy")
class FlashAttnVarlenFuncV3Api(BaseApi):
