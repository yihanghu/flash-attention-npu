"""Cross-input constraints for v4 ``flash_attn_varlen_func``."""
...
@GENERATOR_REGISTRY.register("flash_attn_varlen_func_v4_constraints")
class FlashAttnVarlenFuncV4Constraints(CaseGenerator):
